...
@Configuration
@MapperScan(basePackages = "com.dany.mapper.test2", sqlSessionTemplateRef = "test2SqlSessionTemplate")
public class DataSource2Config {
    ...
    public DataSourceTransactionManager testtTransactionManager(@Qualifier("test2DataSource") DataSource dataSource) {
